"gcp-vnet": {
	type: "component"
	alias: ""
	description: "Google Cloud Virtual Network provided by EvoCloud"
	annotations: {}
	labels: {}
...
template: {
	// gcpVirtualNetwork: https://marketplace.upbound.io/providers/crossplane-contrib/provider-gcp/v0.22.0/resources/compute.gcp.crossplane.io/Network/v1beta1
  output: {
