"gcp-nat-gateway": {
	type: "component"
	alias: ""
	description: "Google Cloud Gateway Router provided by EvoCloud"
	annotations: {}
	labels: {}
...
template: {
	// gcpRouter: https://marketplace.upbound.io/providers/crossplane-contrib/provider-gcp/v0.22.0/resources/compute.gcp.crossplane.io/Router/v1alpha1
  output: {
    ...
    spec: {
    	forProvider: {
    		description: parameter.gatewayDescription
    		privateIpGoogleAccess: true
    		nats: [
    			{
    				name: "router-" + parameter.gatewayName
