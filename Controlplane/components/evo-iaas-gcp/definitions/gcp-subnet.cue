"gcp-subnet": {
	type: "component"
	alias: ""
	description: "Google Cloud Subnet provided by EvoCloud"
	annotations: {}
	labels: {}
...
template: {
	// gcpSubnet: https://marketplace.upbound.io/providers/crossplane-contrib/provider-gcp/v0.22.0/resources/compute.gcp.crossplane.io/Subnetwork/v1beta1
  output: {
    ...
    spec: {
    	forProvider: {
    		description: parameter.subnetDescription
    		privateIpGoogleAccess: true
    		ipCidrRange: parameter.subnetAddressCidr
